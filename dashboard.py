...
Muestra posiciones, historial, logs y rates en tiempo real
"""
...
.topbar{display:flex;align-items:center;justify-content:space-between;padding:14px 24px;background:var(--s);border-bottom:1px solid var(--b)}
...
th{font-size:11px;text-transform:uppercase;letter-spacing:.05em;color:var(--m);padding:10px 16px;text-align:left;border-bottom:1px solid var(--b);font-weight:500}
td{padding:11px 16px;border-bottom:1px solid var(--b);font-size:13px}
...
.pos-grid{display:grid;grid-template-columns:110px 1fr 130px;gap:10px;align-items:center}
...
<div class="container">
  ...
  <div style="display:flex;gap:8px;margin-bottom:20px;flex-wrap:wrap">
    <div class="metric" style="flex:1;min-width:160px">
      <div class="metric-label">Trades spot/perp</div>
      <div class="metric-value muted" id="m-strat1">0</div>
    </div>
    <div class="metric" style="flex:1;min-width:160px">
      <div class="metric-label">Trades spread</div>
      <div class="metric-value muted" id="m-strat2">0</div>
    </div>
  </div>
    ...
    <div class="card">
      <table>
        <thead><tr>
          ...
          <th>Capital</th><th>Rate</th><th>Apertura</th><th>Cierre</th>
...
async function loadSummary(){
  ...
  document.getElementById('m-strat1').textContent=d.spot_perp_trades;
  document.getElementById('m-strat2').textContent=d.spread_trades;
